...
export default class TrackInfoPlayer extends Component {
    state = {
        playingTime: 0,
        volume: 1,
    ...
    render() {
        ...
        return (
            <div className={`track-info-top__player ${this.props.item.isPlaying ? 'active' : ''}`}>
                ...
                <div className="track-info-top__player__playstatus">
                    <span className="track-info-top__player__playstatus__starttime">{playingTime}</span>
                    <div className="track-info-top__player__playstatus__progressbar-container">
                        <input type="range"
                               className="track-info-top__player__playstatus__progressbar"
                               min="0"
                               max="30"
                               step="1"
                    ...
                    <span className="track-info-top__player__playstatus__endtime">0:30</span>
                </div>

                <div className="track-info-top__player__volume">
                    <img src={this.state.volumeSrc} alt="" onClick={this.showVolumeRange}/>

                    <div className={`track-info-top__player__volume__popup ${this.state.isVolumeEditorVisible
                        ? 'show'
                        : ''}`}>
                        <input type="range"
                               className="track-info-top__player__playstatus__progressbar"
